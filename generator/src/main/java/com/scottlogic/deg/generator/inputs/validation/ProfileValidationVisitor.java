...
public class ProfileValidationVisitor implements ProfileVisitor {
    ...
    public void visit(IsAfterConstantDateTimeConstraint constraint) {
        ...
        state.typeConstraintValidator.isOfType(constraint.getField(), TypeDefinition.Temporal);
    ...
    public void visit(IsStringShorterThanConstraint constraint) {
        ...
        state.typeConstraintValidator.isOfType(constraint.getField(), TypeDefinition.String);
    ...
    public void visit(IsGranularToConstraint constraint) {
        ...
        state.typeConstraintValidator.isOfType(constraint.getField(), TypeDefinition.Numeric);
    }
